...
const Results = () => {
  return (
    <div className = "content-lb">
      ...
      <p>
        Sebelum mempelajari bagaimana cara membaca alat ukur SAPA, perlu ditekankan lagi bahwa setiap orang memiliki kekuatannya masing-masing. Dengan berfokus pada kekuatan seseorang, kita bisa membantu mereka menerapkan potensinya secara optimal, mencegah menempatkannya pada pekerjaan dan tugas yang tidak sesuai, dan mendorongnya menjadi lebih bahagia dan produktif. Dengan mereview kekuatan seseorang 
      </p>
      <p>
        Mungkin sebagian dari anda ada yang bertanya, "Bukankah semua orang sudah mengetahui apa kekuatannya?" Tetapi penelitian menunjukkan bahwa sekitar 70% orang tidak mengetahui apa kekuatan dan kelebihannya. Di Indonesia sendiri sebagian besar mahasiswa memilih jurusan yang salah, dan banyak orang yang bekerja tidak sesuai dengan dirinya.
      </p>
      <p>
        Untuk melihat apa kekuatannya, pada bagian Strengths kita dapat melihat 5 kekuatan teratasnya dan mendapatkan gambaran yang cukup akurat mengenai kekuatan utama seeseorang.
      </p>
      <h2>Belajar dan siasati kelemahan</h2>
      <p>
        Walaupun kita harus berfokus melihat kekuatan seseorang, tentu saja bukan berarti kita tidak melihat kelemahannya. Penelitian menunjukkan bahwa manusia cenderung lebih mengingat dan dipengaruhi oleh hal-hal yang negatif. Dimana masalah dan pengalaman buruk akan selalu mempengaruhi diri seseorang. Sehingga kita tidak bisa mengabaikan kelemahan juga; dimana jika aspek negatifnya tidak diperhatikan maka kekuatannya pun akan terhambat.
      </p>
      <p>
        Lalu bagaimana kita menyiasati kelemahannya? Kita perlu kemabli lagi ke kekuatan seseorang, karena tiap orang akan punya cara yang optimal untuk menyiasatinya berdasarkan kekuatannya. Tidak ada satu solusi yang cocok untuk semua orang.
      </p>
      <p>
        Agar lebih jelas, kita bisa bayangkan suatu kasus dimana ada seseorang yang bekerja dalam bagian sosial media dengan nilai kekuatan&nbsp; 
          <Tippy 
          plugins = { [inlinePositioning, animateFill] }
          animateFill = {true}
          inlinePositioning = {true}
        ...
        &nbsp;yang rendah. Tentunya jika kita berfokus pada kelemahannya, kemampuan komunikasi yang rendah ini bisa menjadi hambatan dalam pekerjaannya. Tetapi jika kita melihat kekuatannya, kita bisa mencari cara menyiasati kelemahannya. Misalnya dalam kasus ini kekuatannya di antaranya adalah &nbsp; 
          ...
          . Dengan kekuatannya ini kita bisa menempatkan orang ini dalam bagian pengembangan strategi sosial media, tetapi tanpa perlu berinteraksi dan memanage langsung akun sosial medianya.
        </p>
        <p>
          Dalam situasi itu kita mengubah kelemahan seseorang agar tidak menghambat kinerja dan produktivitas dirinya dan kelompok. Dengan berfokus pada kekuatannya, orang ini dapat berkontribusi secara maksimal dan tidak mengalami stress karena harus melakukan sesuatu yang sulit baginya.
        </p>
        <h2>Signature Strengths</h2>
        <p>
          Sebelum melanjutkan ke bagian selanjutnya, ada satu aspek kekuatan yang cukup penting yang tidak dilihat dalam alat ukur ini. Signature strengths adalah kekuatan yang bukan hanya dimiliki seseorang, tetapi juga menjadi bagian dari identitas dan keunikan seseorang. Signature strengths ketika digunakan terasa mudah dilakukan dan juga membuat orang merasa bahagia, terpenuhi, dan membuat orangnya ingin melakukan lagi dan lagi. Penelitian menunjukkan bahwa ketika seseorang bekerja pada posisi yang menggunakan signature strengthsnya
        </p>
        <h2>Kekuatan bisa berubah dan berkembang</h2>
        <p>
          Kekuatan seseorang bisa berubah dan berkembang. Perubahan-perubahan ini bisa terjadi secara perlahan, maupun tiba-tiba karena ada suatu peristiwa yang signifikan dalam hidup seseorang. Sehingga semua orang perlu diberikan kesempatan untuk menjelajahi kekuatan-kekuatannya yang mungkin belum berkembang, dan menetapkan satu individu dalam satu tipe akan mengurangi kepuasan seseorang untuk mencoba mempelajari hal yang baru.
        </p>
        <h2>Kekuatan bisa digunakan berlebihan</h2>
        <p>
          Hal terakhir yang perlu dipertimbangkan adalah bahwa bagaimana kekuatan seseorang digunakan juga penting diperhatikan. Ketika seseorang tidak menggunakan kekuatannya, secara nalar kita dapat mengerti mengapa hal ini dapat memiliki dampak negatif terhadap seseorang. Tetapi yang mungkin tidak terlalu intuitif adalah bahwa jika seseorang menggunakan kekuatannya secara berlebihan juga dapat menimbulkan dampak yang negatif.
        </p>
    </div>
  )
};
...
const SapaQuote2 = () => {
  return (
    <div className = "second-quote-sapa">
      <p className = "content-sq">
        Menggunakan kekuatan dalam proses
      </p>
    </div>
  )
};

export { LatarBelakang, OpenQuote, LBTitle, SecondQuote, Results, SapaQuote, SapaQuote2 };